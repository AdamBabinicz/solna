...
const Data = [
  ...
  },
  {
    ...
    img: img4,
    Title: "Przygoda z płotem",
    p: "Chodziłem do sąsiadów na telewizję oglądać bajkę na dobranoc „Gąska Balbinka”. Oczywiście obrazki były nieruchome. Pewnego razu gospodyni P. Potemska zamknęła furtkę i musiałem przejść przez płot. Gdy byłem już po drugiej stronie, zaczepiłem podbródkiem o szpic sztachety i nie mogłem się uwolnić. Już nie pamiętam, kto mnie ściągnął z płotu.",
    em: "",
  },
  {
    imgsrc: web4,
